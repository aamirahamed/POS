...
export const NeedsYouBanner: FC = () => {
    ...
    return (
        <div className="absolute top-6 right-6 z-40 max-w-sm w-full">
            <div className="bg-[#121214]/90 backdrop-blur-xl border border-orange-500/30 rounded-2xl p-4 shadow-[0_8px_32px_-12px_rgba(249,115,22,0.4)] flex flex-col gap-3">
