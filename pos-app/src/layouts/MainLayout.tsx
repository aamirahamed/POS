...
import { LayoutDashboard, Network, Bell, Settings, LayoutGrid, GraduationCap, Briefcase, ShoppingCart } from 'lucide-react';
...
const MainLayout: FC = () => {
    ...
    return (
        <div className="flex h-screen w-full bg-background text-text-primary overflow-hidden">
            {/* Sidebar */}
            <aside className="w-64 border-r border-border/80 bg-surface flex flex-col p-4 shadow-[4px_0_24px_-12px_rgba(0,0,0,0.5)] z-10">
                        ...
                        <NavLink
                            ...
                            className={({ isActive }) =>
                                clsx(
                                    ...
                                    item.disabled ? 'opacity-50 cursor-not-allowed' : 'hover:bg-surface-elevated',
